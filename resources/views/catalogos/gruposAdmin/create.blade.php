...
<div class="panel panel-success">
	<div class="panel-heading">
		<h4>Nuevo Grupo Administrativo</h4>
	</div>
	...
	<div class="panel-body">
        ...
        @csrf
				<p>
					<input name="nombre" id="nombre" placeholder="Nombre del grupo" class="form-control" required>
                </p>
                
                <p>
					<input name="descripcion" id="descripcion" placeholder="Descripción del grupo" class="form-control">
				</p>
